...
namespace InteractServer.ProjectPart
{
    public class ConfigValues
    {
        ...
        public class ScreensItemSource : Xceed.Wpf.Toolkit.PropertyGrid.Attributes.IItemsSource
        {
            public Xceed.Wpf.Toolkit.PropertyGrid.Attributes.ItemCollection GetValues()
            {
                ...
                foreach(Screen screen in Global.ProjectManager.Current.Screens.Resources)
                {
        ...
        [Browsable(false)]
        private Shared.Project.ConfigValues backend = new Shared.Project.ConfigValues();
